...
namespace Microsoft.BotBuilderSamples.Dialogs
{
    public class MainDialog : ComponentDialog
    {
            ...
            : base(nameof(MainDialog))
        {
            ...
            DataAPI.DataAPIURL = Configuration["DataService"];

            AddDialog(new TextPrompt(nameof(TextPrompt)));
            AddDialog(new OnSpotDialog());
        ...
        private async Task<DialogTurnResult> IntroStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                return await stepContext.PromptAsync(nameof(TextPrompt), new PromptOptions { Prompt = MessageFactory.Text("What can I help you with today?\nSay something like \"Show yesterday's on spot performance for US Only") }, cancellationToken);
            }
        }
        ...
        private async Task<DialogTurnResult> FinalStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                var result = (OnSpotPerformance)stepContext.Result;
                ...
                var msg = $"You got data for {result.Geo}, {travelDateMsg}";
